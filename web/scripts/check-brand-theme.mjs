...
assert.match(logoComponent, /heard_logo_notext\.svg/);
assert.match(logoComponent, /aria-label="heard\."/);
assert.match(logoComponent, /font-display/);
assert.match(logoComponent, />heard\.<\/span>/);
